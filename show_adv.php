...
$result = mysql_query("SELECT * FROM advert WHERE id='$id'",$db);
		...
		<div class="blog">
			...
			<div id="wrapper_main">
				<div class="main">
					...
					<?php
						echo"<div id='nav'><a href='index.php'>Главная</a> / <a href='adv.php'>Все объявления</a> / <a href=''>" .$myrow['title']."</a></div>";
